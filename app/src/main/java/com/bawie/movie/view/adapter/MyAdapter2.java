...
public class MyAdapter2 extends RecyclerView.Adapter {
    ...
    public MyAdapter2(List<ComingMovieBean.ResultBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.show_time.setText(list.get(position).getMovieId()+"");
        viewHolder.show_ren.setText(list.get(position).getReleaseTime()+"");
        viewHolder.show_ren1.setText(list.get(position).getWantSeeNum()+"");
